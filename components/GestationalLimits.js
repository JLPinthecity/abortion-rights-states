const GestationalLimits = (props) => {
  ...
  //url: 'https://api.abortionpolicyapi.com/v1/gestational_limits/states/Nevada'
  // debugger;
  //boolean 28, 99, or null

  // console.log(props.gestationalLimitsData);

  const banned = props.gestationalLimitsData.banned_after_weeks_since_LMP
    ? props.gestationalLimitsData.banned_after_weeks_since_LMP
    : null;
